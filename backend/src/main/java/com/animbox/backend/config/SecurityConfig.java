...
import com.animbox.backend.auth.service.JwtAuthenticationFilter;
import com.animbox.backend.auth.service.UserDetailsServiceImpl;
...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        config.setAllowedOrigins(List.of("https://animbox.fr", "http://localhost:5173"));
